    ...
    >
      <div className="mb-3 flex items-start justify-between gap-3">
        <div className="flex items-center gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-emerald-500/20 text-base font-black text-emerald-400">
            {user.avatarInitials}
          </div>
          <div>
            ...
            <p className="text-sm uppercase tracking-[0.12em]" style={{ color: isLight ? '#64748b' : '#94a3b8' }}>
              {user.title}
            </p>
          </div>
        </div>
