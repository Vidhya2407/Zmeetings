  ...
  return (
    ...
    >
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        <div className="rounded-2xl border p-3" style={{ borderColor: 'rgba(0,229,186,0.24)', background: 'rgba(0,229,186,0.08)' }}>
          <p className="text-[11px] font-bold uppercase tracking-[0.18em]" style={{ color: 'rgba(0,229,186,0.9)' }}>
            Total saved
          </p>
          <p className="mt-1 text-lg font-black" style={{ color: 'rgb(0,229,186)' }}>
            {totalSavedKg.toFixed(2)} kg
          </p>
        </div>
        <div className="rounded-2xl border p-3" style={{ borderColor: 'rgba(59,130,246,0.22)', background: 'rgba(59,130,246,0.08)' }}>
          <p className="text-[11px] font-bold uppercase tracking-[0.18em]" style={{ color: '#60a5fa' }}>
            Meetings
          </p>
          <p className="mt-1 text-lg font-black" style={{ color: '#60a5fa' }}>
            {meetingsCount}
          </p>
        </div>
      </div>

      <p className="mt-4 text-sm" style={{ color: isLight ? '#475569' : '#9ca3af' }}>
        Avg per meeting:{' '}
