      ...
      <div className="min-h-full" style={{ background: pageBg }}>
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-base leading-7" style={{ color: body }}>
        ...
        <SettingSection title={t('settings.appearanceLanguage', 'Appearance & Language')}>
          <div>
            <p className="mb-3 text-base font-semibold" style={{ color: heading }}>{t('settings.theme', 'Theme')}</p>
          ...
          <div>
            <p className="mb-3 text-base font-semibold" style={{ color: heading }}>{t('settings.interfaceLanguage', 'Interface language')}</p>
            <div className="grid grid-cols-2 gap-2 sm:max-w-xs">
        ...
        <SettingSection title={t('settings.accountProtection', 'Account protection')}>
          <div className="rounded-2xl p-4" style={{ background: isLight ? 'rgba(0,229,186,0.08)' : 'rgba(0,229,186,0.05)', border: '1px solid rgba(0,229,186,0.12)' }}>
            <p className="text-base font-semibold" style={{ color: heading }}>{t('settings.accountProtectionDesc', 'Security, meeting session access, and privacy rights live in one place.')}</p>
        ...
        <SettingSection title={t('settings.privacyTitle', 'Privacy')}>
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              ...
              <button className="rounded-xl py-2.5 text-sm font-bold transition-all" onClick={handleDeletionRequest} style={{ background: 'rgba(239,68,68,0.08)', color: 'rgb(239,68,68)', border: '1px solid rgba(239,68,68,0.2)' }} type="button">
                {deletionRequested ? t('settings.requested', 'Request saved') : t('settings.requestDeletion', 'Request account deletion')}
              </button>
            </div>
            <p className="text-base leading-6" style={{ color: muted }}>{t('settings.deletionNote', 'Account deletion currently downloads a request file for your records; it does not delete the account automatically.')}</p>
          </div>
        </SettingSection>
      </div>
      </div>
